...
demo_note_16 = Note.create!(title: "Test Note 15", body: sample_text_1, notebook_id: demo_notebook_3.id)
demo_note_17 = Note.create!(title: "Test Note 15", body: sample_text_1, notebook_id: demo_notebook_3.id)
demo_note_18 = Note.create!(title: "Test Note 15", body: sample_text_1, notebook_id: demo_notebook_1.id)
demo_note_19 = Note.create!(title: "Test Note 15", body: sample_text_1, notebook_id: demo_notebook_2.id)
demo_note_20 = Note.create!(title: "Test Note 15", body: sample_text_1, notebook_id: demo_notebook_3.id)